...
beautiful.init("/home/smef/.config/awesome/themes/default/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "web", "term", "docs", "media", "other" }, s, awful.layout.layouts[1])
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            cpu_widget{step_width = 3,timeout=1},--color="#4b60b8"},
            --pacman_widget(),
            volume_widget{widget_type = 'icon_and_text',},
            brightness_widget{ program='brightnessctl',type='icon_and_text'},
            mytextclock,
        },
    }
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "F1", function() volume_widget:toggle(0) end),
